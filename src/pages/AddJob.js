...
const Input = ({ name, type, label, register, required }) => {
    ...
    if(label==="description" || label==="qualificationNeeded" || label==="role"  ){
        ...
        return(
            <div className={clas}>
                <label>{num/2}. {name}{required ? <sup>*</sup> : <sup></sup>}</label>
                <input type={type} required={required} {...register(label, { required })} placeholder={name} />
            </div>
        )
    }
}
                ...
                <main className="AddJob__container flex-grow">
                    <form className="AddJob__form" onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            ...
                            <Input type="string" name="Job Code" label="jobCode" register={register} required />
                            <Input type="datetime-local" name="Deadline" label="deadline" register={register} required />
                            <Input type="string" name="Looking for" label="lookingFor" register={register} required />
                            <Input type="string" name="location" label="location" register={register} required />
                            <Input type="string" name="Salary" label="salary" register={register} required />
                            <Input type="string" name="Job Type" label="jobType" register={register} required />
                            <Input type="string" name="eligibility" label="eligibility" register={register} required />
                            ...
                            <Input type="text" name="Qualification needed" label="qualificationNeeded" register={register} required />
