...
class JobProfile extends Component{
    ...
    componentDidMount(){
        ...
        var ret = pathy.replace('/jobs/','');
        // this.setState({id:ret});
        this.setState({
            id: ret
        },() => {
            console.log("insstate",this.state.id)
        });
    }

    render(){
        // console.log(this.state.id,"inrenrder")
        var idi = this.state.id;
        return(
                        ...
                        <div className="jobsProfile__header">
                            ...
                            <div className="jobsProfile__header-button">
                                <ul className="flex flex-grow justify-end flex-wrap items-center">
                                    <li>
                                    <Link to="/home" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800">
                                        <span onClick={() => applyForJob(idi)}>Apply Now</span>
                                    </Link>
                                    </li>
                                </ul>
                            </div>
