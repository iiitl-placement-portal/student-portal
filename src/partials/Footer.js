  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Person A</Link>
              </li>
              <li className="mb-2">
          ...
          <div className="sm:col-span-full md:col-span-3 lg:col-span-2">
            ...
            {/* flex justify-between flex-wrap */}
              ...
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Placement Brochure</Link>
              </li>
            </ul>
          </div>
        ...
        {/* Bottom area */}
        <div className="md:flex md:items-center md:justify-between items-center py-4 md:py-8 border-t border-gray-200">
